...
qualifiers = ("Why do you say that ", "You seem to think that ", "Can you explain why ", "Is it because ", "Are you sure that ")
...
def changePerson(sentence):
	"""Replace first-person words in the sentence with second-person."""
